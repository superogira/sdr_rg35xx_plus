...
- **โหมดรับ 5 โหมด**: NFM → WFM → **USB** → **LSB** → **CW** (วนด้วยปุ่ม
  ...
  เหมาะกับ HF ผ่าน direct sampling
- **Bandwidth ตั้งได้ต่อโหมด** (แถว "Bandwidth" ในเมนู):
  NFM 5/6.25/8/10/12.5/15/20/25 kHz · WFM 50/75/100/150/200/250 kHz ·
  USB/LSB 0.5-3 kHz · CW 50-500 Hz — NFM/WFM เป็นตัวกรองช่องสัญญาณจริง
  (selectivity — ตัดสัญญาณข้างเคียงก่อน demod) ส่วน SSB/CW กำหนด
  ความกว้าง passband เสียง; จำค่าต่อโหมดใน ini (`bw.NFM=12.5` ฯลฯ)
- **Squelch วัดจากพลังงานในช่องสัญญาณแล้ว** (หลังผ่านตัวกรอง bw) —
  เดิมวัดทั้งย่าน ±128kHz ทำให้ carrier แรงข้างเคียงเปิดค้างตลอด
