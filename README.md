...
- **Sample Rate**: สลับ 2.048M (span ±128k) ↔ 1.024M (±64k เหมาะ NFM) —
  server รับการตั้ง rate ได้**ครั้งเดียวต่อการเชื่อมต่อ** แอปจึง
  reconnect ให้เองตอนเปลี่ยน (สัญญาณจะหายไป 2-4 วิ)
